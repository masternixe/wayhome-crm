...
import { MagnifyingGlassIcon, FunnelIcon, MapPinIcon, HomeIcon, CurrencyEuroIcon, XMarkIcon, AdjustmentsHorizontalIcon, HeartIcon as HeartOutline } from '@heroicons/react/20/solid';
